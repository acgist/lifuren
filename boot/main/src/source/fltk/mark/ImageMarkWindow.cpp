...
void lifuren::ImageMarkWindow::drawElement() {
    ...
    // 数学设置
    LFR_CHOICE_ADD_LIST(40,  90, LABEL_IMAGE, fasePtr,    "头部", "发色", "默认");
    LFR_CHOICE_ADD_LIST(160, 90, LABEL_IMAGE, faxingPtr,  "头部", "发型", "默认");
    LFR_CHOICE_ADD_LIST(280, 90, LABEL_IMAGE, meimaoPtr,  "头部", "眉毛", "默认");
    LFR_CHOICE_ADD_LIST(400, 90, LABEL_IMAGE, yanjingPtr, "头部", "眼睛", "默认");
    LFR_CHOICE_ADD_LIST(520, 90, LABEL_IMAGE, biziPtr,    "头部", "鼻子", "默认");
    LFR_CHOICE_ADD_LIST(640, 90, LABEL_IMAGE, yachiPtr,   "头部", "牙齿", "默认");
    // 事件

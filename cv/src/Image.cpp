...
bool lifuren::image::read(const std::string& path, uint8_t** data, size_t& width, size_t& height, size_t& length) {
...
bool lifuren::image::write(const std::string& path, const uint8_t* data, const size_t& width, const size_t& height, size_t length, const size_t& channel) {
    if(data == nullptr) {
        return false;
    }
...
bool lifuren::image::resize(uint8_t* input, size_t width, size_t height, uint8_t* output, size_t output_width, size_t output_height) {
...
void lifuren::image::show(const uint8_t* data, const size_t& width, const size_t& height, const size_t& length) {

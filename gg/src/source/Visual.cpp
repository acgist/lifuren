...
namespace gg {
    ...
    void dots(std::vector<double>* x, std::vector<double>* y, int length, int xLength, int yLength, std::vector<double>* dx, std::vector<double>* dy, const char* title, int width, int height) {
